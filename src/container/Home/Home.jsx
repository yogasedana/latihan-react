    ...
    return (
      <div>
        ...
        <YouTubeComp
          time="8.20"
          title="Langkah 4"
          desc="Yoga Sedana (RYGH) . 700 x ditonton . 4 hari yang lalu"
        />
        <YouTubeComp
          ime="8.20"
          title="Langkah 4"
        ...
        <YouTubeComp
          ime="8.20"
          title="Langkah 4"
          desc="Yoga Sedana (RYGH) . 5110 x ditonton . 4 hari yang lalu"
        />
        <YouTubeComp
          ime="8.20"
          title="Langkah 4"
          desc="Yoga Sedana (RYGH) . 5000 x ditonton . 4 hari yang lalu"
        />
        <YouTubeComp
          ime="8.20"
          title="Langkah 4"
